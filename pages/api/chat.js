...
export default async function handler(req, res) {
  ...
  try {
    ...
    // 1) Imports + clients créés ici (évite crash top-level)
    const [{ createClient }, { default: Mistral }] = await Promise.all([
